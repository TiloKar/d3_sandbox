...
class EventDOMOutputs   {
  ...
  */
  static makeGenericAlertEntry(alertSubClass,alertType,index){
    ...
    alertSystemsString[11] = "Thermostat dry";
    ...
    alertSerialsString[14] = "Error on MFC Bus Channel 5";
    alertSerialsString[15] = "Error on MFC Bus Channel 6";
    ...
    alertSerialsString[26] = "error on Incyte RS485 channel";
    alertSerialsString[27] = "error on Dencyte RS485 channel";
    alertSerialsString[28] = ""; //kopiervorlage
